-- DeanOS one-shot database setup for the Supabase SQL Editor.
-- Paste this entire file into Supabase → SQL Editor → Run.
-- It creates the full Phase 1 schema and records it as applied, so the
-- normal migration runner stays in sync if it is ever used later.
