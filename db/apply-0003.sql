-- Apply migration 0003 (briefs) to an existing DeanOS database.
...
insert into schema_migrations (filename) values ('0003_briefs.sql') on conflict (filename) do nothing;
